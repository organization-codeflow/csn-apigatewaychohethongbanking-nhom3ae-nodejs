# csn-apigatewaychohethongbanking-nhom3ae-nodejs
...
```bash
git clone https://github.com/organization-codeflow/csn-apigatewaychohethongbanking-nhom3ae-nodejs.git
cd csn-apigatewaychohethongbanking-nhom3ae-nodejs
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=csn-apigatewaychohethongbanking-nhom3ae-nodejs
- Xem các metrics:
